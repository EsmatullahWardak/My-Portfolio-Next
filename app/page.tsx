        ...
        <div className='container footer-top'>
          <div className='row gy-4'>
            <div className='col-lg-5 col-md-12 footer-about'>
              ...
              <p>
                Esmat Elham – Crafting modern web applications and intuitive
                user experiences. Connect to explore my projects, discuss ideas,
                or collaborate on innovative solutions..
              </p>
            ...
            <div className='col-lg-3 col-md-12 footer-contact text-center text-md-start'>
              ...
              <p>Afghanistan</p>
              <p className='mt-4'>
                <strong>Phone:</strong> <span>+93786368320</span>
              </p>
              <p>
                <strong>Email:</strong>{" "}
                <span>esmatullah.wardak2020@gmail.com</span>
              </p>
            </div>
          </div>
        </div>
